...
void image::computeFLIPError(image& refImage, image& testImage, bool verbose)
{
    ...
    std::chrono::duration<double> colorDiff;
    std::chrono::duration<double> preprocess,prep0,prep1; 
    std::chrono::duration<double> transform_YCxCz;
    std::chrono::duration<double> featureDiff;
    std::chrono::duration<double> finalError;
    ...
    {   start1=std::chrono::system_clock::now();
        ...
        featureDiff = std::chrono::system_clock::now()-start1;
    }
    ...
    {   start5=std::chrono::system_clock::now(); 
        ...
        prep0 = std::chrono::system_clock::now()-start5;
    }
    ...
    {   start6=std::chrono::system_clock::now();
        ...
        prep1 = std::chrono::system_clock::now()-start6;
    }
    {
        #pragma omp barrier
    }
    ...
    colorDiff = std::chrono::system_clock::now()-start4;}
    ...
    finalError = std::chrono::system_clock::now()-start3;
