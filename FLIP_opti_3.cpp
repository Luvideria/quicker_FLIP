...
void image::computeFeatureDifference(image& refImage, image& testImage, const float ppd)
{
    ...
    /*
    image edgyReference(this->mWidth, this->mHeight);
    image pointyReference(this->mWidth, this->mHeight);
    edgyReference.convolve(refGray, edgeFilters);
    edgyReference.save("edgeref.png");
    pointyReference.convolve(refGray, pointFilters);
    pointyReference.save("pointref.png");
